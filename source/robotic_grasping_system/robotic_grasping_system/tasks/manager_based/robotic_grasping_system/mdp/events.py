...
def randomize_table_height(
    ...
    table_quat = table.data.root_quat_w[env_ids].clone() 

    # TODO: change the hardcaoded values
    env_origins = env.scene.env_origins[env_ids]
    table_pos = env_origins.clone()
    table_pos[:, 0] += 0.6   # table x offset from init_state
...
def randomize_object_placement(
    ...
    table_top_z = env.table_z[env_ids] + 0.25  # half table thickness
